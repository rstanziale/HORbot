...
public class HORcommands {
    ...
    public final static String RESETCONTEXTS = "/resetcontexts";
    public final static String GETRECOMMEND = "/getrecommend";
    public final static String SETCOMPANY = "/setcompany";
    public final static String SETRESTED = "/setrested";
